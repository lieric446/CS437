...
data_path = os.getenv("VEHICLE_EMISSIONS_FOLDER") + "/vehicle{}.csv"

#Path to your certificates, modify this
certificate_formatter = os.getenv("VEHICLES_CERTS_FOLDER") + "/vehicle{}/certificate.pem.crt"
key_formatter = os.getenv("VEHICLES_CERTS_FOLDER") + "/vehicle{}/private.pem.key"
...
class MQTTClient:
    def __init__(self, device_id, cert, key):
        ...
        self.client.configureEndpoint(os.getenv("AWS_BROKER_ADDRESS"), 8883)
        self.client.configureCredentials(os.getenv("AWS_ROOT_PEM"), key, cert)
    ...
    def customOnMessage(self, message):
        ...
        print("client {} received payload {} from topic {}".format(self.device_id, None, None))
